                                            ...
                                            <div id="spid-idp-button-medium-get" class="spid-idp-button spid-idp-button-tip spid-idp-button-relative">
                                                <ul id="spid-idp-list-medium-root-get" class="spid-idp-button-menu" aria-labelledby="spid-idp">       
                                                    <li class="spid-idp-button-link" data-idp="arubaid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/ArubaPEC S.p.A."><span class="spid-sr-only">Aruba ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-arubaid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-arubaid.png'; this.onerror=null;" alt="Aruba ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="infocertid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/InfoCert S.p.A."><span class="spid-sr-only">Infocert ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-infocertid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-infocertid.png'; this.onerror=null;" alt="Infocert ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="intesaid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/IN.TE.S.A. S.p.A."><span class="spid-sr-only">Intesa ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-intesaid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-intesaid.png'; this.onerror=null;" alt="Intesa ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="lepidaid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/Lepida S.p.A."><span class="spid-sr-only">Lepida ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-lepidaid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-lepidaid.png'; this.onerror=null;" alt="Lepida ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="namirialid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/Namirial"><span class="spid-sr-only">Namirial ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-namirialid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-namirialid.png'; this.onerror=null;" alt="Namirial ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="posteid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/Poste Italiane SpA"><span class="spid-sr-only">Poste ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-posteid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-posteid.png'; this.onerror=null;" alt="Poste ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="sielteid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/Sielte S.p.A."><span class="spid-sr-only">Sielte ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-sielteid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-sielteid.png'; this.onerror=null;" alt="Sielte ID" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="spiditalia">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/Register.it S.p.A."><span class="spid-sr-only">SPIDItalia Register.it</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-spiditalia.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-spiditalia.png'; this.onerror=null;" alt="SpidItalia" /></a>
                                                    </li>
                                                    <li class="spid-idp-button-link" data-idp="timid">
                                                        <a href="<?php echo $baseurl; ?>/oidc/rp/authz/TI Trust Technologies srl"><span class="spid-sr-only">Tim ID</span><img src="<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-timid.svg" onerror="this.src='<?php echo $baseurl; ?>/assets/spid-sp-access-button/img/spid-idp-timid.png'; this.onerror=null;" alt="Tim ID" /></a>
                                                    </li>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 text-center">
                                            <li class="btn p-0 border-0 my-3">
                                                <a href="<?php echo $baseurl; ?>/oidc/rp/authz/<?php echo base64_encode('http://127.0.0.1:8000/'); ?>/<?php echo base64_encode('http://spid-cie-oidc-test.linfaservice.it:8000/oidc/op/'); ?>?state=state123">
